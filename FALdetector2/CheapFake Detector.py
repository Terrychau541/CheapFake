...
'probability will be outputted.')


select = st.selectbox('Select Type of CheapFake', ["Comprehensive", "Facial Feature Editing" , "Skin smoothening", "Skintone Changing"])
